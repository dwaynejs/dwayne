...
defineProperties(Elem.prototype, {
  ...
  /**
   * @member {Function} Elem#addClasses
   * @public
  ...
  /**
   * @member {Function} Elem#centerText
   * @public
   * @returns {Elem} Returns this.
  ...
  /**
   * @member {Function} Elem#changeRule
   * @public
   * @param {String} name - Name of the rule.
   * @param {Object.<String, String>} style - Style for the selector.
   * @returns {Elem} Returns this.
  ...
  /**
   * @member {Function} Elem#defaultValue
   * @public
  ...
  /**
   * @member {Function} Elem#deleteRule
   * @public
   * @param {String} name - Name of the rule.
   * @returns {Elem} Returns this.
  ...
  /**
   * @member {Function} Elem#draggable
   * @public
  ...
  first(selector = null) {
    return this.object((elems, elem) => {
      const found = new Super(elem.children).find((elem) => new Elem(elem).is(selector));
  ...
  /**
   * @member {Function} Elem#getFormData
   * @public
