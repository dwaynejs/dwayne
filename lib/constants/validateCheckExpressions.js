...
/**
 * @callback module:constants/validateCheckExpressions~checkCallback
 * @param {*} value - Value to check.
 */

/**
 * @typedef {Object} module:constants/validateCheckExpressions~validateExpr
 * @property {String} text - Text of the thrown error.
 * @property {Error} error - Type of the thrown error.
 * @property {module:constants/validateCheckExpressions~checkCallback} match - Callback for checking value.
 */

/**
 * @type {module:constants/validateCheckExpressions~validateExpr[]}
