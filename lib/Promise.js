...
export class Promise {
   ...
   * @description
   * [Promise API]{@link https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/Promise}.
   *
   * @example
   * new Promise((resolve) => {
   *   resolve(1);
   ...
   * @public
   * @param {Function} onReject - Function that is called when the promise is rejected.
   * @returns {Promise} New instance of Promise.
   ...
   * @method Promise#then
   * @public
   * @param {?Function} onResolve - Function that is called when the promise is resolved.
   * @param {?Function} [onReject] - Function that is called when the promise is rejected.
   * @returns {Promise} New instance of Promise.
 ...
 * @function promise
 * @public
 * @param resolver - Passed to the Promise#constructor.
 * @returns {Promise} New instance of Promise.
