...
export class Super {
	...
	array(mapFn) {
		validate([mapFn], ['function'], 'Super#array');
	...
	call(f) {
		validate([f], ['function'], 'Super#call');
  ...
  create(descriptors) {
	...
	deepEvery(mapFn, n) {
		...
		validate([mapFn, n], ['function', ['intLike', '>0']], 'Super#deepEvery');
	...
	deepFilter(mapFn, n) {
		...
		validate([mapFn, n], ['function', ['intLike', '>0']], 'Super#deepFilter');
	...
	deepFind(mapFn, n) {
		...
		validate([mapFn, n], ['function', ['intLike', '>0']], 'Super#deepFind');
	...
	deepMap(mapFn, n = 1) {
		validate([mapFn, n], ['function', ['intLike', '>0']], 'Super#deepMap');
	...
	deepReduce(mapFn, n = 1, IV) {
		validate([mapFn, n], ['function', ['intLike', '>0']], 'Super#deepReduce');
	...
	deepSome(mapFn, n) {
		...
		validate([mapFn, n], ['function', ['intLike', '>0']], 'Super#deepSome');
	...
	every(mapFn = Boolean) {
		validate([mapFn], ['function'], 'Super#every');
  ...
  filter(mapFn = Boolean) {
		validate([mapFn], ['function'], 'Super#filter');
	...
	find(mapFn) {
		validate([mapFn], ['function'], 'Super#find');
	...
	forEach(mapFn) {
		validate([mapFn], ['function'], 'Super#forEach');
  ...
  instanceof(constructor) {
	...
	map(mapFn) {
		validate([mapFn], ['function'], 'Super#map');
	...
	max(mapFn = null) {
		validate([mapFn], ['function||!'], 'Super#max');
  ...
  prop(property, value) {
	...
	reduce(mapFn, IV) {
		validate([mapFn], ['function'], 'Super#reduce');
