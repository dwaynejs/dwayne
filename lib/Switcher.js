...
import {
  isArray, isFunction, isObject, isUndefined,
  iterate, Symbol, toArray, defineProperties, checkClassInstance
} from './helpers';
 ...
 */
export function Switcher(cases = {}, mode = 'equals', def) {
  checkClassInstance(this, Switcher, 'Switcher');
  ...
  function switcher(value, args = []) {
    ...
    return ret.value.apply(null, toArray(args));
  }
