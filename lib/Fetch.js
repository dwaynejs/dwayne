...
import {
  ...
  assign, supportSymbol, validate, toArray, iterate, defineProperties
} from './helpers';
...
/**
 * @callback ErrorBeforeMiddleware
 * @public
 * @param {Error|*} err - Thrown error.
 * @param {FetchConfig} config - Fetch config.
 * @param {Function} next - If there shouldn't be an error it's needed to be called without arguments
...
export class Fetch extends Function {
   ...
   * @method Fetch#after
   * @public
   * @param {AfterMiddleware|ErrorAfterMiddleware} middleware - Middleware to add.
   ...
   * @method Fetch#before
   * @public
   * @param {BeforeMiddleware|ErrorBeforeMiddleware} middleware - Middleware to add.
   * @returns {Fetch} Returns this.
