...
dynamicDefineProperties(HtmlElement.prototype, css, (value, prop) => {
...
dynamicDefineProperties(HtmlElement.prototype, elements, (value, elem) => {
  return function () {
...
dynamicDefineProperties(HtmlCollection.prototype, collectionMethods, (value, prop) => {
  return function () {
    iterate(this.$, (elem) => {
