...
var Func = function (_Super) {
  ...
  createClass(Func, [{
    ...
    value: function bind(context) {
      ...
      return this.bindContext(context).bindArgs(toArray$1(arguments).slice(1));
    }
  ...
  createClass(Elem, [{
    ...
    value: function create(type) {
      ...
      return this.object(function (elems, elem) {
        ...
        elems.add(element.apply.apply(element, new Arr(_arguments).slice(1).$));
      }, new Elem());
    }
